...
const Estadisticas = () => {
  ...
  return (
    <div>
        <h2 className="text-center mb-4" style={{color: '#333333'}}>Mis Estadísticas</h2>
                        ...
                        <div className="card h-100" style={{ borderColor: '#FFFAFA', boxShadow: '0 2px 5px rgba(0,0,0,0.1)' }}>
                            <div className="card-body text-center">
                                <div className="d-flex justify-content-center align-items-center">
                                    ...
                                    <h5 className="m-0" style={{color: '#333333'}}>Productos Comprados</h5>
                                </div>
                        ...
                        <div className="card h-100" style={{ borderColor: '#FFFAFA', boxShadow: '0 2px 5px rgba(0,0,0,0.1)' }}>
                            <div className="card-body text-center">
                                <div className="d-flex justify-content-center align-items-center">
                                    ...
                                    <h5 className="m-0" style={{color: '#333333'}}>Servicios Solicitados</h5>
                                </div>
                                <h3 style={{ color: '#333', fontWeight: 'bold', marginTop: '10px' }}>
                        ...
                        <div className="card h-100" style={{ borderColor: '#FFFAFA', boxShadow: '0 2px 5px rgba(0,0,0,0.1)' }}>
                            <div className="card-body text-center">
                                <div className="d-flex justify-content-center align-items-center">
                                    ...
                                    <h5 className="m-0" style={{color: '#333333'}}>Gasto Total</h5>
                                </div>
                                <h3 style={{ color: '#333', fontWeight: 'bold', marginTop: '10px' }}>
            ...
            <div className="col-md-6 mb-4">
                <div className="card h-100">
                    <div className="card-header d-flex align-items-center" style={{ backgroundColor: '#f8f9fa' }}>
                        ...
                        <h4 className="mb-0" style={{color: '#333333'}}>Productos Más Comprados</h4>
                    </div>
                    <div className="card-body">
                        {estadisticas.productosMasComprados.length > 0 ? (
                                ...
                                {estadisticas.productosMasComprados.map((producto, index) => (
                                    <li key={producto.id} className="list-group-item d-flex justify-content-between align-items-center">
                                        <div className="d-flex align-items-center">
                                            ...
                                            <span style={{ fontWeight: '500', color: '#333333' }}>{producto.nombre}</span>
                                        </div>
                                        <span className="badge rounded-pill" style={{ backgroundColor: '#6c757d', color: 'white' }}>
                            ...
                            <p className="text-center" style={{color: '#333333'}}>No has realizado ninguna compra todavía.</p>
                        )}
                    </div>
                </div>
            </div>
                ...
                <div className="card h-100">
                    ...
                    <div className="card-body">
                        {estadisticas.maestrosMasSolicitados.length > 0 ? (
                            <ul className="list-group list-group-flush">
                                {estadisticas.maestrosMasSolicitados.map((maestro, index) => (
                                    <li key={maestro.id} className="list-group-item d-flex justify-content-between align-items-center">
                                        <div className="d-flex align-items-center">
                                            <span className="badge rounded-pill me-2" style={{ backgroundColor: '#a65048' }}>{index + 1}</span>
                                            <span style={{ fontWeight: '500', color: '#333333' }}>{maestro.nombre}</span>
                                        </div>
                                        <span className="badge rounded-pill" style={{ backgroundColor: '#6c757d', color: 'white' }}>
                            ...
                            <p className="text-center" style={{color: '#333333'}}>No has solicitado ningún servicio todavía.</p>
                        )}
                    </div>
                </div>
            </div>
